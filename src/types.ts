...
export const MOCK_USERS: User[] = [
  {
    id: 'vendor_1',
    email: 'contact@apex-semiconductor.com',
    role: 'SUPPLIER',
    name: 'Apex Semiconductor Corp',
    companyName: 'Apex Semiconductor Corp',
    companyDescription: 'Pioneered custom integrated circuit packaging and specialist cleanroom spares. Serving worldwide fabrication clients.',
    companyWebsite: 'https://apex-semiconductor.com',
    category: 'MRO & Spare Parts Management',
    location: 'West Tai-Chung, Taiwan',
    avatarUrl: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=150&auto=format&fit=crop&q=80'
  },
  {
    id: 'vendor_2',
    email: 'info@nordic-alloys.no',
    role: 'SUPPLIER',
    name: 'Nordic Specialty Alloys',
    companyName: 'Nordic Specialty Alloys',
    companyDescription: 'Eco-certified smelters of specialized castings, mechanical shafts, and high-pressure structural steel products.',
    companyWebsite: 'https://nordic-alloys.no',
  ...
  {
    id: 'vendor_3',
    email: 'sales@bioniq-polymers.de',
    role: 'SUPPLIER',
    name: 'BionIQ Polymers GmbH',
    companyName: 'BionIQ Polymers GmbH',
    companyDescription: 'Developer of sustainable packaging seals, organic substrates, and custom bio-degradable printed canvases.',
    companyWebsite: 'https://bioniq-polymers.de',
  ...
  },
  {
    ...
    role: 'BUYER',
    name: 'Sarah Chen',
    companyName: 'Tesla Inc (Global Sourcing)',
  },
  {
    id: 'admin_1',
...
export const MOCK_ASSESSMENTS: SupplierAssessment[] = [
  ...
  },
  {
    ...
    riskSummaries: {
      priceRiskSummary: 'Moderate price variance risk. Offers standard payment modes but energy input grids in Norway introduce variable indexing pressures.',
